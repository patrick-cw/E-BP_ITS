...
@section('content')
        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
              ...
              <div class="col-md-12">
                <a class="btn btn-lg btn-primary hover-top rounded-1" style="border-radius:50px ;" href="#Panduan" role="button">Video Panduan Bebas Pustaka</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="pt-5" id="Layanan">
        ...
        <section class="pt-5" style="margin-top: 100px;" id='Footer'>
            <div class="bg-holder" 
            style=" 
